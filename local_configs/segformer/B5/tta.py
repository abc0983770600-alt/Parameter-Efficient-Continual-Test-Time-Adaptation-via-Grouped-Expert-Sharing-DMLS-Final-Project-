...
EXP_NUMS = 6                  # 改成 6，符合 Medium 的設定n
um_step1_domain = 4          # NOTE use it at the decoder part
...
model = dict(
    ...
    auxiliary_head=dict(
        ...
        train_cfg=dict(mode=None, 
                    num_step1_domain = 4,    # 直接寫 4
                    domains = warmup_domains, 
                    expert_num = 6,          # 直接寫 6 (代表你的 Medium 權重)
                        ),

    test_cfg=dict(mode='slide', crop_size=(1024,1024), stride=(768,768), )

    # 原本是： test_cfg=dict(mode='slide', crop_size=(1024,1024), stride=(768,768), )
